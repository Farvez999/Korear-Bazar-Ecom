...
public class NewProdAdapter extends RecyclerView.Adapter<NewProdAdapter.MyViewHolder> {

    private LayoutInflater inflater;
    private ArrayList<NewProdModel> bestModelArrayList;
    Context context;
    public NewProdAdapter(Context ctx, ArrayList<NewProdModel> dataModelArrayList){
        this.context=ctx;
    ...
    @Override
    public NewProdAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View itemView = inflater.inflate(R.layout.product_item, parent, false);
        NewProdAdapter.MyViewHolder holder = new NewProdAdapter.MyViewHolder(itemView);

        return holder;
    }

    @Override
    public void onBindViewHolder(final NewProdAdapter.MyViewHolder holder, final int position) {
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view) {
            ...
            NewProdModel pm=bestModelArrayList.get(postion);
