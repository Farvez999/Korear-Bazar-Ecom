...
public class SaleProdAdapter extends RecyclerView.Adapter<SaleProdAdapter.MyViewHolder> {
    ...
    private ArrayList<SaleProdModel> bestModelArrayList;
    Context context;
    public SaleProdAdapter(Context ctx, ArrayList<SaleProdModel> dataModelArrayList){
        this.context=ctx;
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View view) {
            ...
            SaleProdModel pm=bestModelArrayList.get(postion);
